...
CREATE TABLE IF NOT EXISTS `library_db`.`rentals` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_rentals_clients1_idx` (`client_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `library_db`.`pieces` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_pieces_publishers1_idx` (`publisher_id` ASC) VISIBLE,
  INDEX `fk_pieces_aliases1_idx` (`alias_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `library_db`.`volumes` (
  ...
  `status` ENUM('alocado', 'perdido', 'guardado', 'nao alocavel') NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_volumes_sessions1_idx` (`session_id` ASC) VISIBLE,
  INDEX `fk_volumes_pieces1_idx` (`piece_id` ASC) VISIBLE,
  CONSTRAINT `fk_volumes_sessions1`
    FOREIGN KEY (`session_id`)
    REFERENCES `library_db`.`sessions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_volumes_pieces1`
...
CREATE TABLE IF NOT EXISTS `library_db`.`returns` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_returns_employees1_idx` (`employee_id` ASC) VISIBLE,
  INDEX `fk_returns_rentals1_idx` (`rental_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `library_db`.`volumes_rentals` (
  ...
  `status` ENUM('emprestado', 'devolvido', 'atrasado', 'perdido') NOT NULL DEFAULT 'emprestado',
  PRIMARY KEY (`rental_id`, `volume_id`),
  INDEX `fk_rentals_has_volumes_volumes1_idx` (`volume_id` ASC) VISIBLE,
  INDEX `fk_rentals_has_volumes_rentals1_idx` (`rental_id` ASC) VISIBLE,
  CONSTRAINT `fk_rentals_has_volumes_rentals1`
    FOREIGN KEY (`rental_id`)
    REFERENCES `library_db`.`rentals` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_rentals_has_volumes_volumes1`
