...
-- Fri 16 May 2025 01:20:08 AM UTC
...
CREATE TABLE IF NOT EXISTS `library_db`.`publishers` (
  ...
  `fundation_year` YEAR(4) NOT NULL,
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `library_db`.`rentals` (
  ...
  INDEX `fk_rentals_clients_idx` (`client_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `library_db`.`volumes` (
  ...
  INDEX `fk_volumn_pieces1_idx` (`piece_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `library_db`.`volumes_rentals` (
  ...
  INDEX `fk_volumn_has_rentals_rentals1_idx` (`rental_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `library_db`.`returns` (
  ...
  PRIMARY KEY (`id`, `rentals_id`, `employees_id`),
  INDEX `fk_returns_rentals1_idx` (`rentals_id` ASC) VISIBLE,
